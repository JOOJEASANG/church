...
// ===== 오늘의 말씀 =====
// 전략: 365개의 절 reference를 큐레이션하고, 각 텍스트는
// bible-api.com (한국어 개역한글 krv)에서 자동 fetch하여 캐시.
// 네트워크 없거나 API 실패 시 하드코딩된 50개 폴백 사용.

const VERSE_REFS = [
  // 시편 (Psalms) — 위로·찬양
  '시편 1:1-2','시편 8:4','시편 16:8','시편 18:2','시편 19:1','시편 19:14',
  '시편 23:1','시편 23:4','시편 23:6','시편 27:1','시편 27:4','시편 27:14',
  '시편 30:5','시편 32:8','시편 34:8','시편 34:18','시편 37:4','시편 37:5',
  '시편 37:7','시편 40:1','시편 42:1','시편 42:11','시편 46:1','시편 46:10',
  '시편 51:10','시편 55:22','시편 56:3','시편 62:1','시편 62:8','시편 63:1',
  '시편 63:3','시편 84:10','시편 86:11','시편 90:12','시편 91:1','시편 91:11',
  '시편 94:19','시편 95:6','시편 100:2','시편 100:4','시편 103:1','시편 103:2',
  '시편 103:8','시편 103:13','시편 116:7','시편 118:24','시편 119:11','시편 119:18',
  '시편 119:50','시편 119:71','시편 119:89','시편 119:105','시편 121:1','시편 121:7',
  '시편 126:5','시편 127:1','시편 130:5','시편 138:8','시편 139:1','시편 139:14',
  '시편 139:23','시편 143:8','시편 145:8','시편 145:18','시편 146:5','시편 147:3',
  '시편 150:6',
  // 잠언 — 지혜
  '잠언 1:7','잠언 3:5','잠언 3:9','잠언 4:23','잠언 11:25','잠언 15:1',
  '잠언 16:3','잠언 16:9','잠언 16:32','잠언 17:17','잠언 18:10','잠언 19:21',
  '잠언 22:6','잠언 27:17','잠언 28:13','잠언 31:30',
  // 전도서·이사야·예레미야·기타 선지서
  '전도서 3:1','전도서 3:11','전도서 4:9','전도서 12:13',
  '이사야 9:6','이사야 26:3','이사야 30:15','이사야 40:8','이사야 40:29','이사야 40:31',
  '이사야 41:10','이사야 41:13','이사야 43:1','이사야 43:2','이사야 43:18','이사야 53:5',
  '이사야 55:6','이사야 55:8','이사야 55:11','이사야 60:1',
  '예레미야 17:7','예레미야 29:11','예레미야 29:12','예레미야 33:3',
  '예레미야애가 3:22','미가 6:8','하박국 3:17','스바냐 3:17','말라기 3:10',
  // 모세오경·역사서
  '창세기 1:1','창세기 1:27','창세기 28:15','창세기 50:20',
  '출애굽기 14:14','출애굽기 15:2','출애굽기 33:14',
  '신명기 6:5','신명기 31:6',
  '여호수아 1:8','여호수아 1:9','여호수아 24:15',
  '룻기 1:16','사무엘상 16:7',
  // 마태복음
  '마태복음 4:4','마태복음 5:3','마태복음 5:6','마태복음 5:7','마태복음 5:8','마태복음 5:9',
  '마태복음 5:14','마태복음 5:16','마태복음 5:44','마태복음 6:6','마태복음 6:14','마태복음 6:19',
  '마태복음 6:33','마태복음 6:34','마태복음 7:7','마태복음 7:12','마태복음 11:28','마태복음 11:29',
  '마태복음 18:20','마태복음 19:26','마태복음 22:37','마태복음 25:40','마태복음 28:19',
  // 마가복음·누가복음
  '마가복음 9:23','마가복음 10:27','마가복음 10:45','마가복음 11:24','마가복음 12:30','마가복음 16:15',
  '누가복음 1:37','누가복음 2:14','누가복음 6:31','누가복음 6:38','누가복음 12:7','누가복음 17:21',
  '누가복음 18:1','누가복음 19:10',
  // 요한복음
  '요한복음 1:1','요한복음 1:12','요한복음 3:16','요한복음 4:14','요한복음 6:35','요한복음 8:12',
  '요한복음 8:32','요한복음 10:10','요한복음 10:11','요한복음 11:25','요한복음 13:34','요한복음 14:1',
  '요한복음 14:6','요한복음 14:13','요한복음 14:27','요한복음 15:5','요한복음 15:7','요한복음 15:13',
  '요한복음 16:33','요한복음 17:3','요한복음 20:29',
  // 사도행전·로마서
  '사도행전 1:8','사도행전 2:38','사도행전 4:12','사도행전 16:31','사도행전 17:28','사도행전 20:35',
  '로마서 1:16','로마서 3:23','로마서 5:1','로마서 5:3','로마서 5:8','로마서 6:23',
  '로마서 8:1','로마서 8:18','로마서 8:26','로마서 8:28','로마서 8:31','로마서 8:38',
  '로마서 10:9','로마서 10:17','로마서 12:1','로마서 12:2','로마서 12:12','로마서 12:15',
  '로마서 12:18','로마서 12:21','로마서 13:8','로마서 14:8','로마서 15:13',
  // 고린도전·후서
  '고린도전서 1:18','고린도전서 6:19','고린도전서 10:13','고린도전서 13:4','고린도전서 13:7','고린도전서 13:13',
  '고린도전서 15:58','고린도후서 1:3','고린도후서 4:16','고린도후서 4:17','고린도후서 5:7','고린도후서 5:17',
  '고린도후서 9:7','고린도후서 12:9','고린도후서 13:11',
  // 갈라디아·에베소·빌립보·골로새
  '갈라디아서 2:20','갈라디아서 5:13','갈라디아서 5:22','갈라디아서 6:2','갈라디아서 6:9',
  '에베소서 1:7','에베소서 2:8','에베소서 2:10','에베소서 3:20','에베소서 4:2','에베소서 4:29',
  '에베소서 4:32','에베소서 5:1','에베소서 5:20','에베소서 6:10','에베소서 6:18',
  '빌립보서 1:6','빌립보서 1:21','빌립보서 2:3','빌립보서 2:5','빌립보서 3:13',
  '빌립보서 4:4','빌립보서 4:6','빌립보서 4:8','빌립보서 4:13','빌립보서 4:19',
  '골로새서 1:17','골로새서 3:1','골로새서 3:13','골로새서 3:14','골로새서 3:15','골로새서 3:17','골로새서 3:23',
  // 데살로니가·디모데·디도
  '데살로니가전서 5:11','데살로니가전서 5:16','데살로니가전서 5:21','데살로니가후서 3:3',
  '디모데전서 4:12','디모데전서 6:6','디모데전서 6:12',
  '디모데후서 1:7','디모데후서 3:16','디모데후서 4:7',
  // 히브리서
  '히브리서 4:12','히브리서 4:16','히브리서 10:23','히브리서 10:24','히브리서 11:1','히브리서 11:6',
  '히브리서 12:1','히브리서 12:11','히브리서 13:5','히브리서 13:8',
  // 야고보·베드로
  '야고보서 1:2','야고보서 1:5','야고보서 1:17','야고보서 1:19','야고보서 2:17','야고보서 4:7',
  '야고보서 4:8','야고보서 5:13','야고보서 5:16',
  '베드로전서 1:6','베드로전서 2:9','베드로전서 3:15','베드로전서 4:8','베드로전서 4:10',
  '베드로전서 5:6','베드로전서 5:10','베드로후서 1:5','베드로후서 3:9',
  // 요한1·계시록
  '요한일서 1:9','요한일서 3:1','요한일서 3:18','요한일서 4:7','요한일서 4:18','요한일서 4:19','요한일서 5:14',
  '요한계시록 3:20','요한계시록 21:4','요한계시록 22:13','요한계시록 22:20'
];

// 폴백 (네트워크 실패 시 사용) — 가장 자주 인용되는 50개 한국어 본문
const FALLBACK_VERSES = {
  ...
  '요한일서 4:7': '사랑하는 자들아 우리가 서로 사랑하자 사랑은 하나님께 속한 것이니.'
};

// 영어 책 이름 매핑 (bible-api.com용)
const BOOK_KO_TO_EN = {
...
function refToApiQuery(ref) {
  // '시편 23:1' or '시편 23:1-2' → 'Psalms 23:1'
  const m = ref.match(/^(\S+)\s+(.+)$/);
  if (!m) return null;
  const book = BOOK_KO_TO_EN[m[1]];
  if (!book) return null;
  return encodeURIComponent(`${book} ${m[2]}`);
}

// 캐시 키: verse-{ref} → { text, fetchedAt }
async function fetchVerseText(ref) {
  // 1) 메모리 캐시
  const cacheKey = 'verse:' + ref;
  try {
    const cached = JSON.parse(localStorage.getItem(cacheKey) || 'null');
    if (cached && cached.text && (Date.now() - (cached.fetchedAt || 0)) < 30 * 86400000) {
      return cached.text;
    }
  } catch {}
  // 2) bible-api.com 호출
  const q = refToApiQuery(ref);
  if (q) {
    try {
      const res = await fetch(`https://bible-api.com/${q}?translation=krv`, { cache: 'no-store' });
      if (res.ok) {
        const data = await res.json();
        const text = (data.text || '').trim();
        if (text) {
          try { localStorage.setItem(cacheKey, JSON.stringify({ text, fetchedAt: Date.now() })); } catch {}
          return text;
        }
      }
    } catch {}
...
function getTodaysVerseSync() {
  const ref = getTodaysVerseRef();
  return { ref, text: FALLBACK_VERSES[ref] || '말씀을 불러오는 중...' };
}

// 비동기 — API에서 한국어 본문 fetch (캐시 + 폴백)
